...
# ViT-B-16
python attack.py -log logs/vit_b_16_base.json -model vit_b_16 -weights IMAGENET1K_V2 -results sqlite:///fourier.db -name vit_b_16 -eps 16 -norm Linf -data "$VSC_DATA_VO/ImageNet" -bs 4 -base -trial 52 -iterations 1 -attack autoattack

# Swin-T
python attack.py -log logs/swin_t_base.json -model swin_t -weights IMAGENET1K_V2 -results sqlite:///fourier.db -name swin_t -eps 16 -norm Linf -data "$VSC_DATA_VO/ImageNet" -bs 4 -base -trial 275 -iterations 1 -attack autoattack
